...
//namespace WFCodeGen;
///// <summary>
///// Leaving this here for now. I had converted this over from the 
///// </summary>
//public class CGData : ICodeGenerator
//{
//    public string GeneratedOutputPath { get; private set; }
//    public string GeneratedExtension => ".gen.cs";
//    private string dataClass;
//    public CodeWriter Run(ClassInfo ci)
//    {
//        GeneratedOutputPath = Path.GetDirectoryName(ci.SourceFilePath);
//        bool IsData = ci.IsData;
//        CodeWriter cw = new CodeWriter();
//        ci.GetFields(out var fields, out var xfields);
//        dataClass = ci.Name;
//        cw.line = $"/// <auto-generated/>";
//        cw.line = "using WFLib;";
//        cw.line = "using Godot;";
//        cw.line = "using System;";
//        cw.line = $"namespace {ci.Namespace};";
//        foreach (var line in ci.Comments)
//        {
//            cw.line = "// " + line;
//        }
//        if (IsData)
//        {
//            cw.line = $"public partial class {ci.Name} : Data";
//        }
//        else
//        {
//            cw.line = $"public partial class {ci.Name} : Record";
//        }
...
//        if (IsData)
//        {
//            cw.Add($"public {ci.Name} Rent()=>DataFactory<{ci.Name}>.Rent();");
//            cw.line = $"~{ci.Name}() => Dispose();";
//            cw.line = "public override void Dispose()";
//            cw.line = "{";
//            cw.line = $"DataFactory<{ci.Name}>.Return(this);";
...
//            cw.line = $"public partial class DataField : DataField<{ci.Name}>";
//            cw.Add("{");
...
//        else
//        {
//            cw.Add($"public {ci.Name} Rent()=>RecordFactory<{ci.Name}>.Rent();");
...
//            cw.line = "public override void Dispose()";
//            cw.line = "{";
//            cw.line = $"RecordFactory<{ci.Name}>.Return(this);";
//            cw.line = "base.Dispose();";
//            cw.line = "}";
...
//        FieldMethods(cw, fields, ci.Name);
//        if (IsData)
//        {
//            cw.line = $"public partial class Context : DataContext<{ci.Name}>";
//        }
//        else
//        {
//            cw.line = $"public partial class Context : RecordContext<{ci.Name}>";
//        }
//        cw.line = "{";
//        GenConstructor(cw, fields, xfields, !IsData, ci.Name);
//        if (IsData)
//        {
//            GenDataContextBody(cw, ci.Name);
//        }
//        else
//        {
//            GenRecordContextBody(cw, fields, ci.Name);
//        }
...
//        if (IsData)
//        {
//            GenDataUtil(cw, fields, ci.Name);
//        }
//        else
//        {
//            GenRecordUtil(cw, fields, ci.Name);
//            GenTable(cw, fields, ci.Name);
//        }
//        cw.line = "}";
//        return cw;
//    }
...
//        cw.line = "}";
//    }
//    private void IsEqual(CodeWriter cw, List<FieldInfo> fields)
//    {
...
//        cw.line = "}";
//    }
//    private void FieldCopy(CodeWriter cw, List<FieldInfo> fields)
//    {
...
//        cw.line = "}";
//    }
//    private void ClearActions(CodeWriter cw, List<FieldInfo> fields)
//    {
