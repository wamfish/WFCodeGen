...
public partial class Link : Record
{
	...
	public Link Rent()=>RecordFactory<Link>.Rent();
	...
	{
		RecordFactory<Link>.Return(this);
		base.Dispose();
	}
	...
	public override void FieldCopyTo(Data toData, int field)
	{
		...
		switch(field)
		{
			...
			case 5:to.Desc = Desc; return;
			case 6:to.ChannelID = ChannelID; return;
			case 7:to.Url = Url; return;
			case 8:to.VideoRef = VideoRef; return;
			case 9:to.Tags = Tags; return;
		}
	}
	...
	public override bool FieldIsDefault(int field)
	{
		switch(field)
		{
			...
			case 5:return Desc == string.Empty;
			case 6:return ChannelID.ID == 0;
			case 7:return Url == string.Empty;
			case 8:return VideoRef == string.Empty;
			case 9:return Tags == string.Empty;
		}
		return false;
	}
	public override bool FieldIsEqual(Data toFld, int field)
	{
		if (!(toFld is Link to)) return false;
		switch(field)
		{
			...
			case 5:return Desc == to.Desc;
			case 6:return ChannelID == to.ChannelID;
			case 7:return Url == to.Url;
			case 8:return VideoRef == to.VideoRef;
			case 9:return Tags == to.Tags;
		}
		return false;
	}
	public override string FieldAsString(int field)
	{
		switch(field)
		{
			...
			case 4:return Title;
			case 5:return Desc;
			case 6:return ChannelID.AsString();
			case 7:return Url;
			case 8:return VideoRef;
			case 9:return Tags;
		}
		return string.Empty;
	}
	public override void FieldFromString(string str, int field)
	{
		switch(field)
		{
			...
			case 5:Desc = str; return;
			case 6:ChannelID.ID = str.AsInt(); return;
			case 7:Url = str; return;
			case 8:VideoRef = str; return;
			case 9:Tags = str; return;
		}
		return;
	}
	...
	public override void FieldAsKey(int field, SerializationBuffer sb, int maxSize)
	{
		switch(field)
		{
			...
			case 5:Desc.AsKey(sb, maxSize); return;
			case 6:sb.Write(ChannelID.ID); return;
			case 7:Url.AsKey(sb, maxSize); return;
			case 8:VideoRef.AsKey(sb, maxSize); return;
			case 9:Tags.AsKey(sb, maxSize); return;
		}
	}
	/// <summary>
	...
	public override Object FieldAsObject(int field)
	{
		switch(field)
		{
			...
			case 5:return (Object)Desc;
			case 6:return (Object)ChannelID;
			case 7:return (Object)Url;
			case 8:return (Object)VideoRef;
			case 9:return (Object)Tags;
		}
		return null;
	}
	/// <summary>
	...
	public override void FieldFromObject(Object o,  int field)
	{
		switch(field)
		{
			...
			case 5:Desc = (string) o; return;
			case 6:ChannelID = (RecID<LinkChannel>) o; return;
			case 7:Url = (string) o; return;
			case 8:VideoRef = (string) o; return;
			case 9:Tags = (string) o; return;
		}
	}
	/// <summary>
	...
	public override Type FieldType(int field)
	{
		switch(field)
		{
			...
			case 5:return Desc.GetType();
			case 6:return ChannelID.GetType();
			case 7:return Url.GetType();
			case 8:return VideoRef.GetType();
			case 9:return Tags.GetType();
		}
		return null;
	}
	public partial class Context : RecordContext<Link>
	{
		protected override void OnBaseConstruct()
		{
			table = TableFactory<Table,Link>.Rent();
		}
		internal static void InitContextFactory() => RecordContextFactory<Link>.SetCreateMethod(()=>new Context(),_setEditById);
		static Context()
		{
			InitContextFactory();
		}
		public static Context Rent(int EditByID=-2) => (Context) RecordContextFactory<Link>.Rent(EditByID);
		public override Table Table => (Table) table;
		public override void Dispose()
		{
			RecordContextFactory<Link>.Return(this);
		}
	}
	public static class FID
	{
		...
		public const int VideoRef = 8;
		public const int Tags = 9;
	}
	static object[] Min = { (byte) 0,(int) -2147483648,(long) 0,(int) -2147483648,(int) 0,(int) 0,(int) 0,(int) 0,(int) 0,(int) 0, };
	static object[] Max = { (byte) 255,(int) 2147483647,(long) 3155378975999999999,(int) 2147483647,(int) 0,(int) 0,(int) 0,(int) 0,(int) 0,(int) 0, };
	...
	public partial class Util : RecordUtil<Link>
	{
	}
	public partial class Table : Table<Link>
	{
	}
}
