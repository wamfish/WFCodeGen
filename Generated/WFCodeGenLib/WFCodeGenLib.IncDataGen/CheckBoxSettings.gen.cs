...
public partial class CheckBoxSettings : Data
{
	...
	public CheckBoxSettings Rent()=>DataFactory<CheckBoxSettings>.Rent();
	~CheckBoxSettings() => Dispose();
	public override void Dispose()
	{
		DataFactory<CheckBoxSettings>.Return(this);
		base.Dispose();
	}
	public override bool IsRecord => false;
	public partial class DataField : DataField<CheckBoxSettings>
	{
	...
	{
		if (!(toData is CheckBoxSettings to)) return;
		to.Clear();
	...
	{
		if (!(toFld is CheckBoxSettings to)) return false;
		switch(field)
		{
	...
	public partial class Context : DataContext<CheckBoxSettings>
	{
		protected override void OnBaseConstruct()
		{
			Data = DataFactory<CheckBoxSettings>.Rent();
		}
		public static Context Rent() => (Context) DataContextFactory<CheckBoxSettings>.Rent();
		public override void Dispose()
		{
			DataContextFactory<CheckBoxSettings>.Return(this);
		}
	}
	...
	static Func<Data,string>[] HtmlHelpers = new Func<Data,string>[12];
	public override Func<Data,string>[] StaticHtmlHelpers => HtmlHelpers;
	public partial class Util : DataUtil<CheckBoxSettings>
	{
	}
}
