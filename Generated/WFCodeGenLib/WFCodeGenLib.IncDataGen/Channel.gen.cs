...
using System;
namespace WFCodeGen;
public partial class LinkChannel : Record
{
	...
	public LinkChannel Rent()=>RecordFactory<LinkChannel>.Rent();
	...
	{
		RecordFactory<LinkChannel>.Return(this);
		base.Dispose();
	}
	...
	{
		if (!(toData is LinkChannel to)) return;
		to.Clear();
	...
	public override void FieldCopyTo(Data toData, int field)
	{
		...
		switch(field)
		{
			...
			case 4:to.Name = Name; return;
			case 5:to.Url = Url; return;
	...
	public override bool FieldIsDefault(int field)
	{
		switch(field)
		{
			...
			case 4:return Name == string.Empty;
			case 5:return Url == string.Empty;
	...
	{
		if (!(toFld is LinkChannel to)) return false;
		switch(field)
		{
			...
			case 4:return Name == to.Name;
			case 5:return Url == to.Url;
	...
	public override void FieldFromString(string str, int field)
	{
		switch(field)
		{
			...
			case 4:Name = str; return;
			case 5:Url = str; return;
	...
	public override void FieldAsKey(int field, SerializationBuffer sb, int maxSize)
	{
		switch(field)
		{
			...
			case 4:Name.AsKey(sb, maxSize); return;
			case 5:Url.AsKey(sb, maxSize); return;
	...
	public override Object FieldAsObject(int field)
	{
		switch(field)
		{
			...
			case 4:return (Object)Name;
			case 5:return (Object)Url;
	...
	public override void FieldFromObject(Object o,  int field)
	{
		switch(field)
		{
			...
			case 4:Name = (string) o; return;
			case 5:Url = (string) o; return;
	...
	public override Type FieldType(int field)
	{
		switch(field)
		{
			...
			case 4:return Name.GetType();
			case 5:return Url.GetType();
			case 6:return Tags.GetType();
		}
		return null;
	}
	public partial class Context : RecordContext<LinkChannel>
	{
		protected override void OnBaseConstruct()
		{
			table = TableFactory<Table,LinkChannel>.Rent();
		}
		internal static void InitContextFactory() => RecordContextFactory<LinkChannel>.SetCreateMethod(()=>new Context(),_setEditById);
		static Context()
		{
			InitContextFactory();
		}
		public static Context Rent(int EditByID=-2) => (Context) RecordContextFactory<LinkChannel>.Rent(EditByID);
		public override Table Table => (Table) table;
		public override void Dispose()
		{
			RecordContextFactory<LinkChannel>.Return(this);
		}
		public Status ReadByNameKey(LinkChannel data)
		{
			return Table.NameKey.Read(data,EditByID);
		}
	}
	...
	public partial class Util : RecordUtil<LinkChannel>
	{
		public static Status ReadByNameKey(LinkChannel data,int EditByID=-2)
		{
			...
			var status = context.ReadByNameKey(data);
			return status;
		}
	}
	public partial class Table : Table<LinkChannel>
	{
		public readonly Key NameKey;
		public Table()
		{
			NameKey = new Key(this,FID.Name);
		}
	}
}
